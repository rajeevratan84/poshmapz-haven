      ...
      <div className="container mx-auto px-6">
        <FadeIn>
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="inline-block mb-4 px-3 py-1 bg-blue-50 rounded-full">
              <span className="text-sm font-medium text-posh-blue">Powerful Features</span>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {features.map((feature, index) => (
            <FadeIn key={index} delay={`delay-${Math.min(index * 200, 800)}`} className="h-full">
