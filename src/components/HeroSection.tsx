      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-12">
          <FadeIn delay="delay-0">
            <div className="inline-block mb-4 px-3 py-1 bg-posh-blue/10 rounded-full">
              <span className="text-sm font-medium text-posh-blue">Intelligent mapping for modern businesses</span>
            </div>
          </FadeIn>
          ...
          <FadeIn delay="delay-600">
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              <Button className="w-full sm:w-auto bg-posh-blue hover:bg-blue-500 text-white rounded-full px-8 py-6 text-base">
        ...
        <FadeIn delay="delay-800" className="max-w-4xl mx-auto">
          <div className="relative w-full h-[360px] md:h-[480px] rounded-2xl overflow-hidden shadow-glass bg-white/20 backdrop-blur-xs">
            <div className="absolute inset-0 flex items-center justify-center">
              <Map className="w-20 h-20 text-posh-blue/40 animate-pulse-subtle" />
            </div>
            <div className="absolute top-4 left-4 glass-panel px-3 py-2 rounded-lg flex items-center space-x-2">
              <Compass className="w-4 h-4 text-posh-blue" />
            ...
            <div className="absolute bottom-4 right-4 glass-panel px-3 py-2 rounded-lg flex items-center space-x-2">
              <Zap className="w-4 h-4 text-posh-blue" />
