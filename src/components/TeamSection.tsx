...
const TeamSection: React.FC = () => {
  return (
    <section id="team" className="section-padding dark:bg-black/80 light:bg-gray-50 overflow-hidden">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto">
          <ScrollAnimation type="fade-up" delay={300}>
            <div className="dark:bg-black/60 dark:border-white/10 light:bg-white light:border-gray-200 rounded-2xl shadow-card overflow-hidden">
              <div className="flex flex-col lg:flex-row">
                <div className="lg:w-1/3 p-8 bg-gradient-to-b from-coral/10 to-black/20 flex flex-col items-center justify-center">
                  ...
                  <h3 className="text-2xl font-display font-semibold mb-1 text-center dark:text-white light:text-gray-900">Rajeev Ratan</h3>
                ...
                <div className="lg:w-2/3 p-8">
                  <h4 className="text-xl font-semibold mb-4 dark:text-white light:text-gray-900">About Rajeev</h4>
                  <div className="prose prose-invert max-w-none">
                    <p className="dark:text-white/80 light:text-gray-700">
